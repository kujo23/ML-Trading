...
def get_portfolio_value(prices, allocs, start_val=1):
    ...
    """
    # TODO: Your code here
    pos_val = (prices/prices.ix[0,:])*allocs*start_val
...
def get_portfolio_stats(port_val, daily_rf=0, samples_per_year=252):
    ...
    sharpe_ratio = math.sqrt(samples_per_year) * (avg_daily_ret / std_daily_ret)
...
def test_run():
    ...
    symbol_allocations = OrderedDict([('IBM', 1.0)])  # symbols and corresponding allocations
    ...
    start_val = 10000  # starting value of portfolio
